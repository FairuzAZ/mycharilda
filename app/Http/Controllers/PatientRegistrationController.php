...
class PatientRegistrationController extends Controller
{
    ...
    {
        $registrations = PatientRegistration::with(['user', 'patient', 'insurance', 'service_room'])->get();
    ...
    public function store(StoreNewRegistration $request)
    {
        ...
        PatientRegistration::create($data);
    ...
    {
        $registration = PatientRegistration::findOrFail($id);
        $patients = Patient::all();
        $insurances = Insurance::all();
        $serviceRooms = ServiceRoom::all();
