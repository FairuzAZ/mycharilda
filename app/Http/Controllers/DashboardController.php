...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        $patient_register_today = PatientRegistration::whereDate('created_at', now())->count();
        $patient_register_month = PatientRegistration::whereMonth('created_at', now()->month)->count();
