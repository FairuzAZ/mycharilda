...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
        <img src="{{ asset('logo.png') }}" alt="MyCharilda Logo" class="brand-image" style="opacity: .8">
        <span class="brand-text font-weight-bold">MyCharilda</span>
    </a>
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                @foreach ($menus as $menu)
                    ...
                    <li class="nav-item @if ($hasActiveChild) menu-open @endif">
                        ...
                        @if (count($menu->childs))
                            <ul class="nav nav-treeview" style="{{ $hasActiveChild ? 'display: block;' : 'display: none;' }}">
                                @foreach ($menu->childs as $child)
                                    <li class="nav-item">
