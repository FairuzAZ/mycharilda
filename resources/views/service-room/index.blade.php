...
@section('main-content')
            ...
            <form id="addServiceRoomForm" method="POST" action="{{ route('service-room.store') }}">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="addServiceRoomModalLabel">Tambah Ruang Pelayanan</h5>
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            <label for="ServiceRoomName" class="form-label">Nama Ruang Pelayanan</label>
    ...
    <div class="modal fade" id="editServiceRoomModal" tabindex="-1" aria-labelledby="editServiceRoomModalLabel"
        ...
        <div class="modal-dialog">
            <form id="editServiceRoomForm" method="POST">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="editServiceRoomModalLabel">Edit Ruang Pelayanan</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <div class="mb-3">
                            <label for="editServiceRoomName" class="form-label">Nama Ruang Pelayanan</label>
    ...
    <div class="modal fade" id="deleteServiceRoomModal" tabindex="-1" aria-labelledby="deleteServiceRoomModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="deleteServiceRoomModalLabel">Hapus Ruang Pelayanan</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    Apakah Anda yakin ingin menghapus Ruang Pelayanan ini?
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
