...
@section('main-content')
            ...
            <div class="col-12">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Data Registrasi {{ $registration->patient->first_name }} {{ $registration->patient->last_name }}</h3>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <!-- Left Column -->
            ...
            <div class="col-12">
                        ...
                        <form id="addTransactionForm" method="POST"
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="addTransactionModalLabel">Tambah Tindakan</h5>
                                ...
                                <div class="modal-body">
                                    <div class="mb-3">
                                        <label for="TransactionName" class="form-label">Nama Tindakan</label>
                ...
                <div class="modal fade" id="editTransactionModal" tabindex="-1"
                    ...
                    <div class="modal-dialog">
                        <form id="editTransactionForm" method="POST">
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="editTransactionModalLabel">Edit Tindakan</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                <div class="modal-body">
                                    <div class="mb-3">
                                        <label for="editTransactionName" class="form-label">Nama Tindakan</label>
                ...
                <div class="modal fade" id="deleteTransactionModal" tabindex="-1"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="deleteTransactionModalLabel">Hapus Tindakan</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
    ...
    <div class="row mb-2">
        <div class="col-12">
            <a href="{{ route('patient-registration.index') }}" class="btn btn-primary">Kembali</a>
