...
@section('main-content')
            ...
            <form id="addInsuranceForm" method="POST" action="{{ route('insurance.store') }}">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="addInsuranceModalLabel">Tambah Asuransi</h5>
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            <label for="InsuranceName" class="form-label">Nama Asuransi</label>
    ...
    <div class="modal fade" id="editInsuranceModal" tabindex="-1" aria-labelledby="editInsuranceModalLabel"
        ...
        <div class="modal-dialog">
            <form id="editInsuranceForm" method="POST">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="editInsuranceModalLabel">Edit Asuransi</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <div class="mb-3">
                            <label for="editInsuranceName" class="form-label">Nama Asuransi</label>
    ...
    <div class="modal fade" id="deleteInsuranceModal" tabindex="-1" aria-labelledby="deleteInsuranceModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="deleteInsuranceModalLabel">Hapus Asuransi</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    Apakah Anda yakin ingin menghapus asuransi ini?
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
