...
@section('main-content')
    <div class="card">
        <div class="card-header">
            <a href="{{ route('worker.create') }}" class="btn btn-info">
                ...
                <tbody>
                    @foreach ($users as $index => $user)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('worker.edit', $user->hashid) }}" class="btn btn-sm btn-warning">
                                    <i class="fas fa-pencil-alt"></i>&nbsp;&nbsp;Edit
                                </a>
                                <button type="button"
                                    class="btn btn-sm @if ($user->is_active) btn-danger @else btn-success @endif toggle-btn"
                                    data-url="{{ route('worker.disable', $user->hashid) }}">
                                    @if ($user->is_active)
                                ...
                                <button type="button" class="btn btn-sm btn-danger delete-btn"
                                    data-url="{{ route('worker.destroy', $user->hashid) }}">
