            ...
            <form id="addtreatmentForm" method="POST" action="{{ route('treatment.store') }}">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label for="treatmentPrice" class="form-label">Biaya Tindakan</label>
            ...
            <form id="edittreatmentForm" method="POST">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label for="edittreatmentPrice" class="form-label">Biaya Tindakan</label>
